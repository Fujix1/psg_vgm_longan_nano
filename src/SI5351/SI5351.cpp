...
// new frequency
void SI5351_cls::setFreq(si5351Freq_t newFreq) {
  ...
  switch (newFreq) {
    case SI5351_4000:
      // 4MHz
      setupPLLInt(SI5351_PLL_A, 32); // 25MHz * 32 = 800
      setupMultisynth(0, SI5351_PLL_A, 200, 0, 1);
      break;
    case SI5351_3579:
      // 3.57954545 MHz
      setupPLL(SI5351_PLL_A, 28, 15909, 250000);
      setupMultisynth(0, SI5351_PLL_A, 196, 0, 1);
      break;
    case SI5351_1500:
      // 1.5MHz
      setupPLL(SI5351_PLL_A, 30, 0, 1);
      setupMultisynth(0, SI5351_PLL_A, 500, 0, 1);
      break;
    case SI5351_3000:
      // 3MHz
      setupPLL(SI5351_PLL_A, 30, 0, 1);
      setupMultisynth(0, SI5351_PLL_A, 250, 0, 1);
      break;
    case SI5351_3072:
      // 3.072MHz
      setupPLL(SI5351_PLL_A, 27, 2409, 3125);
      setupMultisynth(0, SI5351_PLL_A, 226, 0, 1);
      break;
    case SI5351_3332:
      // 3.332 MHz
      setupPLL(SI5351_PLL_A, 27, 15534, 15625);
      setupMultisynth(0, SI5351_PLL_A, 210, 0, 1);
      break;
    case SI5351_4500:
      // 4.5 MHz
      setupPLL(SI5351_PLL_A, 27, 0, 1);
      setupMultisynth(0, SI5351_PLL_A, 150, 0, 1);
      break;
    case SI5351_3500:
      // 3.5 MHz
      setupPLL(SI5351_PLL_A, 35, 0, 1);
      setupMultisynth(0, SI5351_PLL_A, 250, 0, 1);
      break;
    default:
      // 4MHz
